[![Build Status](https://dev.azure.com/singhajaypal/azureML/_apis/build/status%2FajaypalSiemensAccount.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/singhajaypal/azureML/_build/latest?definitionId=6&branchName=master)
